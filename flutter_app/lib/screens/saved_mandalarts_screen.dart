...
class SavedMandalartsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SavedMandalartsScreen> createState() =>
      _SavedMandalartsScreenState();
}
...
class _SavedMandalartsScreenState extends ConsumerState<SavedMandalartsScreen> {
  ...
  Future<void> _loadSavedMandalarts() async {
    ...
    final mandalarts =
        await ref.read(mandalartProvider.notifier).getSavedMandalarts();
    setState(() {
  ...
  void _showDeleteDialog(SavedMandalartMeta meta) {
    showCupertinoDialog(
      ...
      builder: (context) => CupertinoAlertDialog(
        ...
        content: Text(
            '${meta.displayName.trim().isNotEmpty ? meta.displayName.trim() : "이 만다라트"}를 삭제하시겠습니까?'),
        actions: [
