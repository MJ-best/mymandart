...
class _GoalInputDialogState extends ConsumerState<GoalInputDialog> {
  ...
  void _submit() {
    ...
    ref.read(mandalartProvider.notifier).updateDisplayName(_nameController.text.trim());
    ref.read(mandalartProvider.notifier).updateGoal(_goalController.text.trim());
  ...
  Widget build(BuildContext context) {
    ...
    return CupertinoPageScaffold(
      navigationBar: CupertinoNavigationBar(
        ...
        leading: widget.isNew ? null : CupertinoButton(
